 ...
 *                  function prototypes for BMX160.c
 *
...
// The headers were provided by the manufacturer:           https://github.com/DFRobot/DFRobot_BMX160/blob/master/DFRobot_BMX160.h
...
/** Acc. Power Mode command */
#define BMX160_ACC_PMU_MODE_SUSPEND_CMD         0x10
#define BMX160_ACC_PMU_MODE_NORMAL_CMD          0x11
#define BMX160_ACC_PMU_MODE_LOW__CMD            0x12
#define BMX160_ACC_DELAY_MS                     15

/** Gyro Power Mode command */
#define BMX160_GYRO_PMU_MODE_SUSPEND_CMD        0x14
#define BMX160_GYRO_PMU_MODE_NORMAL_CMD         0x15
#define BMX160_GYRO_PMU_MODE_FAST_STARTUP_CMD   0x17
#define BMX160_GYRO_DELAY_MS                    81

/** Mag Power Mode command */
#define BMX160_MAG_PMU_MODE_SUSPEND_CMD         0x18
#define BMX160_MAG_PMU_MODE_NORMAL_CMD          0x19
#define BMX160_MAG_PMU_MODE_LOW__CMD            0x1A
#define BMX160_MAG_DELAY_MS                     5
...
#define BMX160_ACCEL_MG_LSB_2G                  0.000061035F   ///< Macro for mg per LSB at +/- 2g sensitivity (1 LSB = 0.000061035mg)  ( 1 / 16384) */
#define BMX160_ACCEL_MG_LSB_4G                  0.000122070F   ///< Macro for mg per LSB at +/- 4g sensitivity (1 LSB = 0.000122070mg)  ( 1 / 8192)*/
#define BMX160_ACCEL_MG_LSB_8G                  0.000244141F   ///< Macro for mg per LSB at +/- 8g sensitivity (1 LSB = 0.000244141mg)  ( 1 / 4096)*/
#define BMX160_ACCEL_MG_LSB_16G                 0.000488281F   ///< Macro for mg per LSB at +/- 16g sensitivity (1 LSB = 0.000488281mg) ( 1 / 2048)*/

#define BMX160_GYRO_SENSITIVITY_125DPS          0.0038110F ///< Gyroscope sensitivity at 125dps  (1 LSB = 0.0038110mg)  ( 1 / 262.4) */
#define BMX160_GYRO_SENSITIVITY_250DPS          0.0076220F ///< Gyroscope sensitivity at 250dps  (1 LSB = 0.0076220mg)  ( 1 / 131.2) */
#define BMX160_GYRO_SENSITIVITY_500DPS          0.0152439F ///< Gyroscope sensitivity at 500dps  (1 LSB = 0.0152439mg)  ( 1 / 65.6) */
#define BMX160_GYRO_SENSITIVITY_1000DPS         0.0304878F ///< Gyroscope sensitivity at 1000dps (1 LSB = 0.0304878mg)  ( 1 / 32.8)  */
#define BMX160_GYRO_SENSITIVITY_2000DPS         0.0609756F ///< Gyroscope sensitivity at 2000dps (1 LSB = 0.0609756mg)  ( 1 / 16.4) */
...
#define BMX160_MAGN_UT_LSB      (0.3F)  ///< Macro for micro tesla (uT) per LSB (1 LSB = 0.3uT) */
